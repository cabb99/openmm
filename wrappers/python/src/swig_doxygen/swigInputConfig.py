...
SKIP_METHODS = [('State', 'getPositions'),
                ...
                ('CalcCustomResiduePairForceKernel',),
...
STEAL_OWNERSHIP = {("Platform", "registerPlatform") : [0],
                   ...
                   ("CustomResiduePairForce", "addTabulatedFunction") : [1],
...
("CustomResiduePairForce", "getAcceptorParameters") : (None, ()),
("CustomResiduePairForce", "getDonorParameters") : (None, ()),
("CustomResiduePairForce", "getEnergyFunction") : (None, ()),
("CustomResiduePairForce", "getExclusionParticles") : (None, ()),
("CustomResiduePairForce", "getFunctionParameters") : (None, ()),
("CustomResiduePairForce", "getNumAcceptors") : (None, ()),
("CustomResiduePairForce", "getNumDonors") : (None, ()),
("CustomResiduePairForce", "getNumExclusions") : (None, ()),
("CustomResiduePairForce", "getNumFunctions") : (None, ()),
("CustomResiduePairForce", "getNumGlobalParameters") : (None, ()),
("CustomResiduePairForce", "getNumPerAcceptorParameters") : (None, ()),
("CustomResiduePairForce", "getNumPerDonorParameters") : (None, ()),
("CustomResiduePairForce", "getGlobalParameterName") : (None, ()),
("CustomResiduePairForce", "getPerAcceptorParameterName") : (None, ()),
("CustomResiduePairForce", "getPerDonorParameterName") : (None, ()),

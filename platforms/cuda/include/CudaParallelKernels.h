 ...
 */
class CudaParallelCalcCustomResiduePairForceKernel : public CalcCustomResiduePairForceKernel {
public:
    CudaParallelCalcCustomResiduePairForceKernel(std::string name, const Platform& platform, CudaPlatform::PlatformData& data, const System& system);

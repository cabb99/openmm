 ...
 */
class OpenCLParallelCalcCustomResiduePairForceKernel : public CalcCustomResiduePairForceKernel {
public:
    OpenCLParallelCalcCustomResiduePairForceKernel(std::string name, const Platform& platform, OpenCLPlatform::PlatformData& data, const System& system);
    CommonCalcCustomResiduePairForceKernel& getKernel(int index) {
        return dynamic_cast<CommonCalcCustomResiduePairForceKernel&>(kernels[index].getImpl());
    }
    /**
     * Initialize the kernel.
     *
